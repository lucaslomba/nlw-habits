    ...
    return(
        <TouchableOpacity 
            className={clsx("rounded-lg border-2 m-1", {
                ...
                'bg-violet-900 border-violet-500': amountAccomplishedPercentage > 0 && amountAccomplishedPercentage < 20,
                'bg-violet-800 border-violet-500': amountAccomplishedPercentage >= 20 && amountAccomplishedPercentage < 40,
